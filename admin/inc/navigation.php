              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-2">
                   <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/tentangkami" class="nav-link nav-about">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/layanan" class="nav-link nav-services">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/mitra" class="nav-link nav-clients">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/staff" class="nav-link nav-testimonials">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/kontak" class="nav-link nav-contact">
                    ...
                    <<?php /* 
<li class="nav-item">
  <a class="nav-link nav-inquiries" href="./?page=inquiries">
...
*/ ?>
    ...
    $(function(){
    var page = '<?php echo $page ?>'; // bukan dari $_GET lagi
    // … logika addClass('active') seperti semula …
  });
  </script>