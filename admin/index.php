...
<?php require_once('inc/header.php') ?>
  <body class="layout-fixed layout-footer-fixed text-sm sidebar-mini control-sidebar-slide-open layout-navbar-fixed " data-new-gr-c-s-check-loaded="14.991.0" data-gr-ext-installed="" style="height: auto;">
    <div class="wrapper">
     ...
     <?php
// ===== Router slug -> halaman asli =====
// URL cantik: /admin/tentangkami, /admin/layanan, dst
$raw  = $_GET['page'] ?? 'home';
$slug = strtolower(trim($raw, '/'));       // "TentangKami" -> "tentangkami"
$routes = [
  'tentangkami'  => 'about',        // /admin/tentangkami -> about.php
  'tentang-kami' => 'about',        // (opsional)
  'tentang_kami' => 'about',        // (opsional)
  'layanan'      => 'services',
  'mitra'        => 'clients',
  'staff'        => 'testimonials',
  'kontak'       => 'contact',
...
$page = $routes[$slug] ?? $slug;

// blokir halaman tertentu (opsional)
if ($page === 'inquiries') {
  header('Location: ./');
  exit;
}
            ...
            <div class="row mb-2">
              ...
              <!-- <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">
                  <?php echo isset($pageTitles[$page]) ? $pageTitles[$page] : ucwords(str_replace("_", " ",$page)); ?>
                </li>
              </ol>
              </div> -->
              <!-- /.col -->
